...
const CACHE_NAME = 'hodgins-openhouse-v13';
const ASSETS = [
  './',
  './index.html',
  './styles.css',
  ...
  './logo-monogram.png',
  './fonts/Adam-Bold.ttf',
  './fonts/LouisGeorgeCafe-Regular.ttf',
  './fonts/LouisGeorgeCafe-Bold.ttf',
  './fonts/LouisGeorgeCafe-Light.ttf',
  './fonts/LouisGeorgeCafe-BoldItalic.ttf',
  './fonts/LouisGeorgeCafe-Italic.ttf',
  './fonts/LouisGeorgeCafe-LightItalic.ttf'
];
